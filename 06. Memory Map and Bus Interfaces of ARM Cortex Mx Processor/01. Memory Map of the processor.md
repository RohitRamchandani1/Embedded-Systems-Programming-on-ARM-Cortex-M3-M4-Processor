...
- The peripheral registers should not fall under the code region.
...
- E.g. Connecting External SDRAM.
  ...
  <img src="image-5.png" width=400px height=200px>

- If the Project requires more RAM like Audio Buffers, Video Buffers etc. we can use the External RAM Region.

## 4. External Device Region
- This region is intended for external devices and/or shared memory.

- This is a eXecute Never (XN) region.

  <img src="image-6.png" width=400px height=200px>

## 5. Private Peripheral Bus Region
- This region includes the NVIC, System timer, and system control block.

- This is a eXecute Never(XN) region.

  <img src="image-8.png" width=800px height=200px>
